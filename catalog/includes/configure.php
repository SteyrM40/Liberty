...
define("APP_DOC_ROOT", "/catalog");
define("APP_DIR_ROOT", dirname ( dirname ( __FILE__ ) ) );

# These should be fine as is
define("APP_MODEL",      APP_DIR_ROOT . "/model");
define("APP_INCLUDES",   APP_DIR_ROOT . "/includes");
define("APP_VIEW",       APP_DIR_ROOT . '/view');
define("APP_JSCRIPT",    APP_DOC_ROOT . "ext/bootstrap/js");
define("APP_IMAGES",     APP_DOC_ROOT . "/images");
